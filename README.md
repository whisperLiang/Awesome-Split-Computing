...
## 2025 ##
- DNN Partitioning for GPU–CPU Heterogeneous Devices Based on Imitation Learning, <ins>IEEE Internet of Things Journal</ins>, [[article](https://doi.org/10.1109/jiot.2025.3624053)], [[code](https://github.com/edgeflow-lab/imitation-dnn-partition)].
...
- Fast and fair split computing for accelerating deep neural network (DNN) inference, <ins>ICT Express</ins>, [[article](https://www.sciencedirect.com/science/article/pii/S2405959524001164)].
...
- Optimal Branch Location for Cost-effective Inference on Branchynet, <ins>International Conference on Big Data (Big Data)</ins>, [[article](https://ieeexplore.ieee.org/abstract/document/9671948)].

- Packet-Loss-Tolerant Split Inference for Delay-Sensitive Deep Learning in Lossy Wireless Networks, <ins>Global Communications Conference (GLOBECOM)</ins>, [[article](https://ieeexplore.ieee.org/abstract/document/9685179)].
...
- Joint Device-Edge Inference over Wireless Links with Pruning, <ins>International Workshop on Signal Processing Advances in Wireless Communications (SPAWC)</ins>, [[article](https://ieeexplore.ieee.org/abstract/document/9154306)].
